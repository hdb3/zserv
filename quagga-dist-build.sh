...
# debian reqs : autoconf automake libtool make gawk libreadline-dev  libc-ares-dev texinfo dejagnu  groff librpmbuild3 libsnmp-dev  libcap-dev texi2html pkg-config
